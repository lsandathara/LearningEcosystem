...
public class VideoBasedScreeningTest1 extends AppCompatActivity {
    ...
    String actualSentence = "ලේනා ටිං ටිං ගෑවා";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_based_screening_test1);
        ...
        //playGuidanceAudio();
        VideoView squirrelVideo = (VideoView)findViewById(R.id.squirrel_video);

        squirrelVideo.setVideoURI(Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.squirrel_sub));

        squirrelVideo.start();

        squirrelVideo.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            @Override
        ...
        speechRecognizer = SpeechRecognizer.createSpeechRecognizer(VideoBasedScreeningTest1.this);
    ...
    private void getVoiceInput(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            if (!(ContextCompat.checkSelfPermission(VideoBasedScreeningTest1.this, Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED)){
    ...
    public void showDialog(){
        ...
        //bundle.putString("time", timeText);
        className = "VideoBasedScreeningTest1";
