...
public class VideoBasedSolutionTest2 extends AppCompatActivity {
    ...
    String actualSentence = "ඉර පායලා";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_based_solution_test2);
        ...
        VideoView sunVideo = (VideoView)findViewById(R.id.sun_video);

        sunVideo.setVideoURI(Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.sun_video));

        sunVideo.start();

        sunVideo.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            @Override
        ...
        speechRecognizer = SpeechRecognizer.createSpeechRecognizer(VideoBasedSolutionTest2.this);
    ...
    private void getVoiceInput(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            if (!(ContextCompat.checkSelfPermission(VideoBasedSolutionTest2.this, Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED)){
    ...
    public void showDialog(){
        ...
        //bundle.putString("time", timeText);
        className = "VideoBasedSolutionTest2";
