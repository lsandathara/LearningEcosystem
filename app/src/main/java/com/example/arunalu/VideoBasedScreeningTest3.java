...
public class VideoBasedScreeningTest3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_based_screening_test3);

        playGuidanceAudio();

        VideoView beachVideo = (VideoView)findViewById(R.id.beach_video);

        beachVideo.setVideoURI(Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.beach_sub));

        beachVideo.start();

        beachVideo.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            @Override
        ...
        speechRecognizer = SpeechRecognizer.createSpeechRecognizer(VideoBasedScreeningTest3.this);
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onResults(Bundle bundle) {
                ...
                if (matches != null){
                    ...
                    //Toast.makeText(VideoBasedScreeningTest3.this,"Result = "+inputSentence,Toast.LENGTH_LONG).show();
                    timer.cancel();
                    showDialog();
                    correctWord = 0;
                    incorrectWord = 0;
        ...
        timer = new CountDownTimer(totalSeconds*1000, intervalSeconds*1000) {
            public void onTick(long millisUntilFinished) {
                ...
                System.out.println("TIMER : "+(totalSeconds * 1000 - millisUntilFinished) / 1000 + ":" + millisUntilFinished % 1000);
            }
    ...
    private void getVoiceInput(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            if (!(ContextCompat.checkSelfPermission(VideoBasedScreeningTest3.this, Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED)){
...
//        bundle.putString("time", timeText);
        className = "VideoBasedScreeningTest3";
