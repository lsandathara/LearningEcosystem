...
public class VideoBasedSolutionTest6 extends AppCompatActivity {
    ...
    String actualSentence = "මල් පිපිලා හරි සුවඳයි";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_based_solution_test6);
        ...
        VideoView flowerVideo = (VideoView)findViewById(R.id.flower_video);

        flowerVideo.setVideoURI(Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.flower_video));

        flowerVideo.start();

        flowerVideo.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            @Override
        ...
        speechRecognizer = SpeechRecognizer.createSpeechRecognizer(VideoBasedSolutionTest6.this);
    ...
    private void getVoiceInput(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            if (!(ContextCompat.checkSelfPermission(VideoBasedSolutionTest6.this, Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED)){
    ...
    public void showDialog(){
        ...
        //bundle.putString("time", timeText);
        className = "VideoBasedSolutionTest6";
